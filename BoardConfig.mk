...
ifdef KLTE_MARSHMALLOW
	TARGET_PREBUILT_KERNEL := device/samsung/klteskt/zImage-M
	TARGET_PREBUILT_DTB := device/samsung/klteskt/dtb.img-M
else
	TARGET_PREBUILT_KERNEL := device/samsung/klteskt/zImage-L
	TARGET_PREBUILT_DTB := device/samsung/klteskt/dtb.img-L
endif
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/klteskt/bootimg.mk
